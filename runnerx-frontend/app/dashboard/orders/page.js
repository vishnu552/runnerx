            ...
            >
              ...
              >
                ...
                <span style={{
                  ...
                  color: order.orderType === 'REGISTRATION' ? '#ffc83c' : order.orderType === 'DONATION' ? '#7c3aed' : '#0891b2',
                }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '10px', fontSize: '0.85rem' }}>
                    ...
                    {order.paymentId && (
                      <div style={{ gridColumn: '1 / -1' }}>
                        <span style={{ color: 'var(--text-muted)' }}>Transaction ID:</span> <strong style={{ fontFamily: 'monospace', letterSpacing: '0.05em' }}>{order.paymentId}</strong>
                      </div>
                    )}
